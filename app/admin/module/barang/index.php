        ...
        <table class="table table-bordered table-striped table-sm" id="example1">
            ...
            <tbody>
                ...
                foreach ($hasil as $isi) {
                    // Periksa apakah ID barang atau nama barang cocok dengan kriteria pencarian
                    if ($_GET['id_barang'] && $isi['id_barang'] != $_GET['id_barang']) {
                        continue; // Lewati iterasi ini jika ID barang tidak cocok
                    }
                    if ($_GET['nama_barang'] && stripos($isi['nama_barang'], $_GET['nama_barang']) === false) {
                        continue; // Lewati iterasi ini jika nama barang tidak cocok
                    }
                ?>
                    <tr>
                        <td><?php echo $no; ?></td>
